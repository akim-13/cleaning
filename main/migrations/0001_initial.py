# Generated by Django 5.1.1 on 2024-09-12 11:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='zones', to='main.location', verbose_name='Объект')),
            ],
            options={
                'verbose_name': 'Зона',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation_criteria', models.CharField(max_length=255, verbose_name='Операция/Критерий оценивания')),
